                    ...
                    <div class="blog-item">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-10 blog-content">
                                ...
                                <a class="btn btn-primary readmore" href="blog.php?n=<? echo $row['id'] ?>">Seguir leyendo <i class="fa fa-angle-right"></i></a> <hr>
                                ...
                                <ul class="tag-cloud">                                    
                                        <li> 
                                            ...
                                            <?
                                                $etiq = $row['tags'];
                                                $sql_et = mysql_query("SELECT id, nombre FROM tags WHERE id ='$etiq'");
